 ...
 */
#ifndef __SX1276LORA_H__
#define __SX1276LORA_H__
#include<stdint.h>
/*!
...
typedef struct sSX1276LR
{
    ...
    uint8_t RegTestReserved2B;                      // 0x2B-0x30
    uint8_t RegTestReserved2C;                      // 0x2c
    uint8_t RegTestReserved2D;                      // Ox2d
    uint8_t RegTestReserved2E;                      // Ox2e
    uint8_t RegTestReserved2F;                      // Ox2f
    uint8_t RegTestReserved30;                      // Ox30
    
    uint8_t RegDetectOptimize;                      // 0x31    
    uint8_t RegTestReserved32;                      // 0x32   
    uint8_t RegInvertIQ;                            // 0x33 
    uint8_t RegTestReserved34;                      // 0x34-0x36
    uint8_t RegTestReserved35;                      // 0x35
    uint8_t RegTestReserved36;                      // 0x36
    uint8_t RegDetectionThreshold;                  // 0x37
    uint8_t RegTestReserved38;                      // 0x38-0x3F
    uint8_t RegTestReserved39;                      // 0x38-0x3F
    uint8_t RegTestReserved3A;                      // 0x38-0x3F
    uint8_t RegTestReserved3B;                      // 0x38-0x3F
    uint8_t RegTestReserved3C;                      // 0x38-0x3F
    uint8_t RegTestReserved3D;                      // 0x38-0x3F
    uint8_t RegTestReserved3E;                      // 0x38-0x3F
    uint8_t RegTestReserved3F;                      // 0x38-0x3F
    ...
    // Test
    uint8_t RegTestReserved45;                      // 0x45-0x4A
    uint8_t RegTestReserved46;                      // 0x45-0x4A
    uint8_t RegTestReserved47;                      // 0x45-0x4A
    uint8_t RegTestReserved48;                      // 0x45-0x4A
    uint8_t RegTestReserved49;                      // 0x45-0x4A
    uint8_t RegTestReserved4A;                      // 0x45-0x4A
    // Additional settings    
    ...
    // Test    
    uint8_t RegTestReserved4E;                      // 0x4E-0x5A
    uint8_t RegTestReserved4F;                      // 0x4E-0x5A
    uint8_t RegTestReserved50;                      // 0x4E-0x5A
    uint8_t RegTestReserved51;                      // 0x4E-0x5A
    uint8_t RegTestReserved52;                      // 0x4E-0x5A
    uint8_t RegTestReserved53;                      // 0x4E-0x5A
    uint8_t RegTestReserved54;                      // 0x4E-0x5A
    uint8_t RegTestReserved55;                      // 0x4E-0x5A
    uint8_t RegTestReserved56;                      // 0x4E-0x5A
    uint8_t RegTestReserved57;                      // 0x4E-0x5A
    uint8_t RegTestReserved58;                      // 0x4E-0x5A
    uint8_t RegTestReserved59;                      // 0x4E-0x5A
    uint8_t RegTestReserved5A;                      // 0x4E-0x5A
    // Additional settings
    ...
    // Additional settings    
    uint8_t RegTestReserved5E;                      // 0x5E-0x60
    uint8_t RegTestReserved5F;                      // 0x5E-0x60
    // Additional settings
    ...
    // Test
    uint8_t RegTestReserved64;                      // 0x64-0x70
    uint8_t RegTestReserved65;                      // 0x64-0x70
    uint8_t RegTestReserved67;                      // 0x64-0x70
    uint8_t RegTestReserved68;                      // 0x64-0x70
    uint8_t RegTestReserved69;                      // 0x64-0x70
    uint8_t RegTestReserved6A;                      // 0x64-0x70
    uint8_t RegTestReserved6B;                      // 0x64-0x70
    uint8_t RegTestReserved6C;                      // 0x64-0x70
    uint8_t RegTestReserved6D;                      // 0x64-0x70
    uint8_t RegTestReserved6E;                      // 0x64-0x70
    uint8_t RegTestReserved6F;                      // 0x64-0x70
}tSX1276LR;
